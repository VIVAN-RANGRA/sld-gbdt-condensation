...
## 3. Quick Focused Binary Replication
...
## 4. Core Paper Tables: 26 Datasets, Five Seeds
...
## 5. Three-Seed Diagnostic, Phase-2, and Breadth Tables

These commands match the paper's lighter 17-method/phase-2 diagnostic grid, where the PDF reports 156 dataset--budget--seed cells per method.
...
python scripts\29_run_breadth_experiments.py --config configs\dataset26_binary.yaml --paper-materials paper_materials --task both --budgets 25,50 --seeds 0,1,2 --n-jobs 8
