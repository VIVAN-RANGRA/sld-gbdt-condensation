...
surrogates: GOSS/MVS are converted into static weighted subsets using their
per-instance sampling scores under the fixed GBDT state; GraNd/EL2N use
fixed-state instance scores; CRAIG/GradMatch use their published
subset-selection objectives over the same processed feature/score representation;
