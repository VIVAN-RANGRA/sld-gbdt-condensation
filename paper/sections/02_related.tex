...
relative $\mathrm{SLD}_\infty=4.72$, and root agreement $=0.0$. This confirms
that SLD can audit C\textsuperscript{2}TC-generated surrogates, but the single
compatibility run is not a full C\textsuperscript{2}TC baseline and should not
