...
this as a compatibility and scope check, not a comparative result. Because this
is a single Adult-budget-200 compatibility run, we do not interpret the result as
evidence about C\textsuperscript{2}TC's general performance. The run confirms
that SLD can audit C\textsuperscript{2}TC-generated surrogates, but it is not a
full C\textsuperscript{2}TC baseline.
